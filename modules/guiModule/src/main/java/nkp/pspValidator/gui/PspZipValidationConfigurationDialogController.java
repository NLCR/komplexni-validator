...
public class PspZipValidationConfigurationDialogController extends DialogController {
    ...
    private void initChoiceBoxes() {
        ...
        Collections.sort(forcedAdgVersions, new VersionComparator());
        ...
        Collections.sort(preferredAdgVersions, new VersionComparator());
        ...
        Collections.sort(preferredAdfVersions, new VersionComparator());

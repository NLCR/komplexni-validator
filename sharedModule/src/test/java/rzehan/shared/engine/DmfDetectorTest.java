...
import rzehan.shared.DmfDetector;
...
public class DmfDetectorTest {
    ...
    public void detectDmfVersionMonograph() {
        ...
        DmfDetector dmfDetector = new DmfDetector();
        try {
            String version = dmfDetector.detectDmfVersion(Dmf.Type.MONOGRAPH, pspRootDir);
    ...
    public void detectDmfVersionPeriodical() {
        ...
        DmfDetector dmfDetector = new DmfDetector();
        try {
            String version = dmfDetector.detectDmfVersion(Dmf.Type.PERIODICAL, pspRootDir);

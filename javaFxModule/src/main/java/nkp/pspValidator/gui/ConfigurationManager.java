...
public class ConfigurationManager {
    ...
    public static final String PROP_FORCE_AUDIO_DOC_GRAM_VERSION_ENABLED = "force.audio_doc_gram.version.enabled";
    public static final String PROP_FORCE_AUDIO_DOC_GRAM_VERSION_CODE = "force.audio_doc_gram.version.code";
    ...
    public static final String PROP_PREFER_AUDIO_DOC_GRAM_VERSION_ENABLED = "prefer.audio_doc_gram.version.enabled";
    public static final String PROP_PREFER_AUDIO_DOC_GRAM_VERSION_CODE = "prefer.audio_doc_gram.version.code";
